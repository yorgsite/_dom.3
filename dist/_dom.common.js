...
var effectHandlers = new WeakMap();
var DomSignalEffectHandler = /** @class */ (function () {
    function DomSignalEffectHandler(register) {
        effectHandlers.set(this, register);
    }
    DomSignalEffectHandler.prototype.destroy = function () {
        var regEffect = effectHandlers.get(this);
        regEffect.alive = false;
        regEffect.registries.forEach(function (r) {
            r.effects.delete(regEffect);
        });
        regEffect.registries.clear();
    };
    return DomSignalEffectHandler;
}());
var DomSignalRegistredEffect = /** @class */ (function () {
    function DomSignalRegistredEffect(callback) {
        this.callback = callback;
        this.alive = true;
        this.registries = new Set();
    }
    return DomSignalRegistredEffect;
}());
var DomSignalOptions = /** @class */ (function () {
    function DomSignalOptions(opt) {
        var _a, _b;
        this.equal = (_a = opt === null || opt === void 0 ? void 0 : opt.equal) !== null && _a !== void 0 ? _a : (function (v1, v2) { return v1 === v2; });
        this.transform = (_b = opt === null || opt === void 0 ? void 0 : opt.transform) !== null && _b !== void 0 ? _b : (function (v) { return v; });
    }
    return DomSignalOptions;
}());
var DomSignals = /** @class */ (function () {
    function DomSignals() {
         ...
         */
        this.signal = function (value, opt) {
            var options = new DomSignalOptions(opt);
            var returnedValue = options.transform(value);
            var signal = function () {
                if (_this_1.currentEffects[0]) {
                    registry.effects.add(_this_1.currentEffects[0]);
                    _this_1.currentEffects[0].registries.add(registry);
                }
            ...
            signal.set = function (v, forceChange) {
                ...
                if (forceChange || !options.equal(v, value)) {
                    ...
                    registry.effects.forEach(function (e) { return _this_1.callEffect(e); });
                }
            };
            var registry = { effects: new Set() };
        ...
        this.effect = function (callback) {
            var regEffect = new DomSignalRegistredEffect(callback);
            _this_1.currentEffects.unshift(regEffect);
            callback();
            _this_1.currentEffects.shift();
         ...
         * that could be destroyed while one of the handled signals would persist.
         */
        this.computed = function (callback, opt) {
            var signal = _this_1.signal(undefined, opt);
            var result = function () { return signal(); };
            result.destroy = _this_1.effect(function () { return __awaiter(_this_1, void 0, void 0, function () {
                var _a, _b;
    ...
    DomSignals.prototype.callEffect = function (eff) {
        var _this_1 = this;
        this.pendingEffects.add(eff);
        if (!this.pendingEffectsId) {
            this.pendingEffectsId = requestAnimationFrame(function () {
                var stack = Array.from(_this_1.pendingEffects.values());
                _this_1.pendingEffects.clear();
                _this_1.pendingEffectsId = 0;
                stack.filter(function (elt) { return elt.alive; }).forEach(function (elt) { return elt.callback(); });
            });
        }
    };
    return DomSignals;
}());
exports.MemberSignal = (_a = new DomSignals(), _a.MemberSignal), exports.signal = _a.signal, exports.effect = _a.effect, exports.computed = _a.computed;
